...
public class FilmeData {
    ...
    public static List<Movie> todos() {
        return List.of(
                criarFilme("1", "Senhor dos Anéis: A Comunidade do Anel", "Peter Jackson", List.of("Fantasia", "Aventura", "Drama"), 208, 2001,
                        ...
                        "https://image.tmdb.org/t/p/w500/6oom5QYQ2yQTMJIbnvbkBL9ILka.jpg",
                        List.of(new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0NVH5C127JYJW17EH3HH0NJIPM"),
                                new Platform("HBO Max", "https://www.hbomax.com/br/pt/movies/senhor-dos-aneis-a-comunidade-do-anel/"))),
                criarFilme("2", "Interestelar", "Christopher Nolan", List.of("Ficção Científica", "Drama", "Aventura"), 169, 2014,
                        ...
                        "https://image.tmdb.org/t/p/w500/eb2d4pfISapUhy6zLl2CaOdLar.jpg",
                        List.of(new Platform("Netflix", "https://www.netflix.com/title/70024472"),
                                new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0RNGSQR00JJDLBVJHJ9QDAFJRQ"))),
                criarFilme("3", "Parasita", "Bong Joon-ho", List.of("Drama", "Thriller"), 132, 2019,
                        ...
                        "https://image.tmdb.org/t/p/w500/aw4glCcPFHicals87mpInqvande.jpg",
                        List.of(new Platform("Netflix", "https://www.netflix.com/title/81288052"),
                                new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0SF29PVRNSQRDMRNMM1FQKK3P0"))),
                criarFilme("4", "De Volta para o Futuro", "Robert Zemeckis", List.of("Ficção Científica", "Comédia", "Aventura"), 116, 1985,
                        ...
                        "https://image.tmdb.org/t/p/w500/fw02lwpOAxYxxcZA1Z60DYzIW4w.jpg",
                        List.of(new Platform("Netflix", "https://www.netflix.com/title/60003712"),
                                new Platform("HBO Max", "https://www.hbomax.com/br/pt/movies/de-volta-para-o-futuro/"))),
                criarFilme("5", "Clube da Luta", "David Fincher", List.of("Drama", "Thriller"), 139, 1999,
                        ...
                        "https://image.tmdb.org/t/p/w500/pB8BM7pdSp6B6Ih7QZ4DrQ3PchJ.jpg",
                        List.of(new Platform("Netflix", "https://www.netflix.com/title/70021576"),
                                new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0O5Q3V6L2I8KJZP9T0XQYB7W6"))),
                criarFilme("6", "Whiplash", "Damien Chazelle", List.of("Drama", "Música"), 107, 2014,
                        ...
                        "https://image.tmdb.org/t/p/w500/lIv1QinFjJnwSEfQeredetcSYwjb.jpg",
                        List.of(new Platform("Netflix", "https://www.netflix.com/title/70308933"),
                                new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0LCRMB4Z0UJVWF47NZHR5K2R94"))),
                criarFilme("7", "Oldboy", "Park Chan-wook", List.of("Ação", "Thriller", "Crime"), 120, 2003,
                        ...
                        "https://image.tmdb.org/t/p/w500/c6Pmm8OVo3j92CKSSkmTe9jBDT8.jpg",
                        List.of(new Platform("Netflix", "https://www.netflix.com/title/70047127"),
                                new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0H8BD2C4TVQS1ZMYNPQ0R1VN6Y"))),
                criarFilme("8", "A Viagem de Chihiro", "Hayao Miyazaki", List.of("Animação", "Aventura"), 125, 2001,
                ...
                criarFilme("9", "Seven", "David Fincher", List.of("Thriller", "Crime", "Drama"), 127, 1995,
                        ...
                        List.of(new Platform("Netflix", "https://www.netflix.com/title/70022152"),
                                new Platform("HBO Max", "https://www.hbomax.com/br/pt/movies/seven/"))),
                criarFilme("10", "As Crônicas de Spiderwick", "Mark Waters", List.of("Fantasia", "Aventura", "Comédia"), 112, 2008,
                        ...
                        List.of(new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0GUKG9C1Q5KJZP2XQYB8YVZP7"),
                                new Platform("HBO Max", "https://www.hbomax.com/br/pt/movies/as-cronicas-de-spiderwick/"))),
                criarFilme("11", "O Pálido Olho Azul", "S. Darko", List.of("Horror", "Drama"), 90, 2007,
                        ...
                        List.of(new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0I6KLMNOQPQRQ2XQYB8YVZP9Z"),
                                new Platform("Apple TV", "https://tv.apple.com/br/movie/o-palido-olho-azul/"))),
                criarFilme("12", "Paprika", "Satoshi Kon", List.of("Animação", "Ficção Científica"), 104, 2006,
                ...
                criarFilme("13", "Castelo Animado", "Hayao Miyazaki", List.of("Animação", "Fantasia", "Romance"), 119, 2004,
                        ...
                        List.of(new Platform("Netflix", "https://www.netflix.com/title/70047291"),
                                new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0GUKG9C1Q5KJZP2XQYB8YVZP7"))),
                criarFilme("14", "Túmulo dos Vagalumes", "Isao Takahata", List.of("Animação", "Drama", "Guerra"), 89, 1988,
                        ...
                        List.of(new Platform("Netflix", "https://www.netflix.com/title/80216616"),
                                new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0LCRMB4Z0UJVWF47NZHR5K2R94"))),
                criarFilme("15", "O Homem Invisível", "Leigh Whannell", List.of("Horror", "Thriller", "Ficção Científica"), 125, 2020,
                        ...
                        List.of(new Platform("Netflix", "https://www.netflix.com/title/81016255"),
                                new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0LCRMB4Z0UJVWF47NZHR5K2R94"))),
                criarFilme("16", "10 Coisas Que Eu Odeio em Você", "Gil Junger", List.of("Comédia", "Romance", "Drama"), 97, 1999,
                        ...
                        List.of(new Platform("Netflix", "https://www.netflix.com/title/60004051"),
                                new Platform("Amazon Prime Video", "https://www.primevideo.com/detail/0GUKG9C1Q5KJZP2XQYB8YVZP7"))));
    }
